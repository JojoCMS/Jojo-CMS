 ...
 *
 * $Horde: framework/Text_Filter/Filter.php,v 1.26 2007/01/02 12:47:28 jan Exp $
 *
...
class Text_Filter {
     ...
     */
    static function filter($text, $filters = array(), $params = array())
    {
        if (!is_array($filters)) {
        ...
        foreach ($filters as $num => $filter) {
            ...
            if ($filterOb instanceof PEAR_Error) {
    ...
    static function &factory($driver, $params = array())
    {
        ...
        if (!class_exists($class)) {
            if (!empty($dir)) {
                ...
                include_once 'Text_Filter/' . $driver . '.php';
            }
        }
