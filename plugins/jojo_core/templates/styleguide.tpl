...
<p><img width="150" height="110" title="roll-over text for image" alt="logo" src="images/logo.png" />Default Inserted Image &gt; Text handling. Lorem ipsum dolor sit amet, consectetur adipisicing elit,
sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.
Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris
nisi ut aliquip ex ea commodo consequat.
</p>
...
<p><img class="float-right" width="150" height="110" title="roll-over text for image" alt="logo" src="images/logo.png" />Styled Inserted Image &gt; Text handling (selected image + .right-image style). Lorem ipsum dolor sit amet, consectetur adipisicing elit,
sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.
Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris
nisi ut aliquip ex ea commodo consequat.
</p>
