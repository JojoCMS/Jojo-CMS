    ...
    {if !$templateoptions || $templateoptions.frajax || $isadmin || $show_frajax || $pg_link=="jojo_plugin_jojo_wiki"}<iframe src="javascript:false;" name="frajax-iframe" id="frajax-iframe" style="display:none; height: 0; width: 0; border: 0;"></iframe>
