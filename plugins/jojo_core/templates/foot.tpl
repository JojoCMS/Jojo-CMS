...
{/if}{if $OPTIONS.jquery_head=='no' && !$isadmin}<script src="https://ajax.googleapis.com/ajax/libs/jquery/{if $isadmin}1.9.1{elseif $OPTIONS.jquery_version}{$OPTIONS.jquery_version}{else}1.9.1{/if}/jquery.min.js" defer ></script>{if $OPTIONS.jquery_ui=='yes'} 
...
<script src="{$RESOURCEURL}/js/common.js" defer></script>
