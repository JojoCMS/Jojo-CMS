    {if !$templateoptions || $templateoptions.frajax || $isadmin || $show_frajax}<iframe src="javascript:false;" name="frajax-iframe" id="frajax-iframe" style="display:none; height: 0; width: 0; border: 0;"></iframe>
