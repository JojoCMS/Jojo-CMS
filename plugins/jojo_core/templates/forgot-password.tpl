...
{/if}
Please enter your{if Jojo::getOption('users_require_unique_email', 'no')=='yes'} email address or{/if} login and select an option below.<br /><br />
<form method="post" action="{$pg_url}/">
    ...
    <div class="form-group">
        <label for="search" class="control-label">{if Jojo::getOption('users_require_unique_email', 'no')=='yes'}Email Address or {/if}Login</label>
