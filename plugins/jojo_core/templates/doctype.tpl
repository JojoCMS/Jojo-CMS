...
{if $boilerplatehtmltag}<!--[if lt IE 7 ]> <html xmlns="http://www.w3.org/1999/xhtml" {if $ogxmlns && !$isadmin}{$ogxmlns} {/if}lang="{if $pg_htmllang}{$pg_htmllang}{elseif $pg_language}{$pg_language}{else}en{/if}" class="no-js ie6"> <![endif]-->
...
{else}<html xmlns="http://www.w3.org/1999/xhtml" {if $ogxmlns && !$isadmin}{$ogxmlns} {/if}lang="{if $pg_htmllang}{$pg_htmllang}{elseif $pg_language}{$pg_language}{else}en{/if}">{/if}
{else}{$xmldoctype}
