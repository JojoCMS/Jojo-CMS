...
<!--[if (gte IE 9)|!(IE)]><!--> <html {if $ogxmlns}{$ogxmlns} {/if}lang="{if $pg_htmllang}{$pg_htmllang}{elseif $pg_language}{$pg_language}{else}en{/if}" class="no-js"> <!--<![endif]-->
...
<html xmlns="http://www.w3.org/1999/xhtml" {if $ogxmlns}{$ogxmlns} {/if}xml:lang="{if $pg_htmllang}{$pg_htmllang}{elseif $pg_language}{$pg_language}{else}en{/if}" lang="{if $pg_htmllang}{$pg_htmllang}{elseif $pg_language}{$pg_language}{else}en{/if}">
{/if}