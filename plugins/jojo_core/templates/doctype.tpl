...
<!--[if (gte IE 9)|!(IE)]><!--> <html lang="{if $pg_htmllang}{$pg_htmllang}{elseif $pg_language}{$pg_language}{else}en{/if}" class="no-js"> <!--<![endif]-->
{else}<html lang="{if $pg_htmllang}{$pg_htmllang}{elseif $pg_language}{$pg_language}{else}en{/if}">{/if}
{else}<?xml version="1.0" encoding="{if $charset}{$charset}{else}utf-8{/if}" ?>
