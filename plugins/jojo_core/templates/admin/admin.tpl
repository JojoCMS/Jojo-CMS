...
<div class="admin-home-item-left">
    ...
    <ul>
      ...
      <li><a href="{$ADMIN}/edit/page/{$toppages[t].pageid}/" onclick="document.cookie='jstree_select=' + escape('#{$toppages[t].pageid}') + ';path=/{$SITEFOLDER}/{$ADMIN}/edit/page/;';return true;">{if $toppages[t].pg_menutitle}{$toppages[t].pg_menutitle}{else}{$toppages[t].pg_title}{/if}</a></li>
      {/section}
      </ul>
            </li>
            {if $articles}
