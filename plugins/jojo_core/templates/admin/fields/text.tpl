...
{else}
<input type="text" name="fm_{$fd_field}" id="fm_{$fd_field}" size="{$fd_size}" value="{$value}" class="span{if $fd_size>=40}5{elseif $fd_size>10}3{else}1{/if}"  title="{$fd_help}" />{if $fd_units} {$fd_units}{/if}
{/if}
{/if}