...
$_options[] = array(
    ...
    'description' => 'The number of articles to show on the index page before paginating',
    'type'        => 'integer',
    'default'     => '40',
    'options'     => '',
    'plugin'      => 'jojo_article'
...
$_options[] = array(
    ...
    'description' => 'Show articles as a separate list on the site map, or in-place on the page list',
    'type'        => 'radio',
    'default'     => 'inplace',
